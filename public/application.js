...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://infinite-lake-73977.herokuapp.com/',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onCreateProject = function onCreateProject(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.createProject(data).then(ui.createProjectSuccess).catch(ui.createProjectFailure
	  // .then(() => {
	...
	var onGetProject = function onGetProject(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.getProject(data).then(ui.getProjectSuccess).catch(ui.getProjectFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getProject = function getProject(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/projects/',
	    method: 'GET',
	    headers: {
	...
	var updateProject = function updateProject(data, newProject) {
	  event.preventDefault();
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var api = __webpack_require__(9);
	var showProjectTemplate = __webpack_require__(12);
	var getFormFields = __webpack_require__(8);
	...
	var checkForProjectOnSignIn = function checkForProjectOnSignIn() {
	  api.getProject().then(signInGetProjectSuccess);
	};

	var signInGetProjectSuccess = function signInGetProjectSuccess(data) {
	  // console.log('data.projects[0].title ', data.projects[0].title)
	  if (data.projects.length === 0) $('#new-project-modal-button').removeClass('hidden');else {
	    if (data.projects.length === 1)
	      // $('#new-project-modal-button').removeClass('hidden')
	      $('#creation-content').removeClass('hidden');
	...
	var refreshProject = function refreshProject(data) {
	  var showProjectHtml = showProjectTemplate({ projects: store.projectList });
	  resetForms();
	  $('.content').empty();
	...
	var nullProject = function nullProject(data) {
	...
	var createProjectSuccess = function createProjectSuccess(response) {
	  ...
	  api.getProject().then(getProjectSuccess);
	};

	var createProjectFailure = function createProjectFailure(error) {
	  console.error(error);
	};

	var createTasksSuccess = function createTasksSuccess(response) {
	  console.log(response);
	};

	var createTasksFailure = function createTasksFailure(error) {
	  console.error(error);
	};

	var getProjectSuccess = function getProjectSuccess(data) {
	...
	var deleteProjectSuccess = function deleteProjectSuccess(response) {
	  console.log(response);
	...
	var deleteProjectFailure = function deleteProjectFailure(error) {
	  console.error(error);
	};

	var updateProjectSuccess = function updateProjectSuccess(response) {
	  console.log(response);
	  store.project = response.project;
	  nullProject(store.project
	  // $('#creation-content').html('<h3><b>Project Title:</b> ' + store.project.title + '</h3><br><h4>' + '<b>Project Description:</b> ' + store.project.description + '</h4>')
	...
	var updateProjectFailure = function updateProjectFailure(error) {
	  console.error(error);
	};
	...
	var onUpdateProject = function onUpdateProject(event) {
	  ...
	  // console.log(data)
	  );var newProject = $(event.target).attr('data-id'
	  // $('.update').trigger('reset')
	  );refreshProject();
	  api.updateProject(data, newProject).then(updateProjectSuccess).then(function () {
	    api.getProject().then(getProjectSuccess).catch(getProjectFailure).catch(updateProjectFailure);
	  });
	};

	var onDeleteProject = function onDeleteProject(event) {
	  event.preventDefault();
	  var removeProject = $(event.target).attr('data-id');
	  store.projectList = store.projectList.filter(function (project) {
	    return String(project.id) !== String(removeProject);
	  });
	  refreshProject();
	  api.deleteProject(removeProject).then(deleteProjectSuccess).catch(deleteProjectFailure).then(function () {
	    api.getProject().then(getProjectSuccess).catch(getProjectFailure);
	  });
	};
	...
	module.exports = {
	  ...
	  createTasksSuccess: createTasksSuccess,
	  createTasksFailure: createTasksFailure,
	  getProjectSuccess: getProjectSuccess,
	  getProjectFailure: getProjectFailure,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <div data-id=\""
	    ...
	    + "\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n\n    <div class=\"container-fluid\">\n      <br>\n       <input class=\"form-control handlebars-update\" type=\"text\" name=\"project[title]\" id=\"handlebars-project-name\" placeholder=\"Project title: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "\">\n       <br>\n       <div class=\"form-group\">\n     <textarea class=\"form-control handlebars-update\" name=\"project[description]\" id=\"handlebars-project-desc\" rows=\"7\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.projects : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "74e93fa8bb8a857467caa66074201bac.jpg";
